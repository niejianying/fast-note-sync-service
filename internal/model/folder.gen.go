...
type Folder struct {
	...
	Path             string     `gorm:"column:path;type:varchar(768);index:idx_folder_vault_id_level_path,priority:3;index:idx_folder_vault_id_fid_path,priority:3;index:idx_folder_vault_id_path,priority:2;default:''" json:"path" form:"path"`
	PathHash         string     `gorm:"column:path_hash;type:varchar(768);index:idx_folder_vault_id_path_hash,priority:2;default:''" json:"pathHash" form:"pathHash"`
