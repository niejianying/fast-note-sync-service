...
type NoteLink struct {
	...
	TargetPathHash string     `gorm:"column:target_path_hash;type:varchar(768);not null;index:idx_target_path_hash,priority:1;default:''" json:"targetPathHash" form:"targetPathHash"`
