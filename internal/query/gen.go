...
func Use(db *gorm.DB, opts ...gen.DOOption) *Query {
	return &Query{
		...
		FriendRelationship:  newFriendRelationship(db, opts...),
...
func (q *Query) clone(db *gorm.DB) *Query {
	return &Query{
		...
		FriendRelationship:  q.FriendRelationship.clone(db),
...
func (q *Query) ReplaceDB(db *gorm.DB) *Query {
	return &Query{
		...
		FriendRelationship:  q.FriendRelationship.replaceDB(db),
...
type queryCtx struct {
	...
	File               IFileDo
	Folder             IFolderDo
	FriendRelationship IFriendRelationshipDo
...
func (q *Query) WithContext(ctx context.Context) *queryCtx {
	return &queryCtx{
		...
		FriendRelationship:  q.FriendRelationship.WithContext(ctx),
