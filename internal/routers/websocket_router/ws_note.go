...
func (h *NoteWSHandler) NoteModify(c *pkgapp.WebsocketClient, msg *pkgapp.WebSocketMessage) {
	...
	noteSvc := h.App.GetNoteServiceWithVault(c.Context(), params.Vault, c.ClientType, c.ClientName, c.ClientVersion)
...
func (h *NoteWSHandler) NoteRename(c *pkgapp.WebsocketClient, msg *pkgapp.WebSocketMessage) {
	...
	uid := c.User.UID
	oldNote, newNote, err := h.App.GetNoteServiceWithVault(c.Context(), params.Vault, c.ClientType, c.ClientName, c.ClientVersion).Rename(c.Context(), uid, params)
	if err != nil {
...
func (h *NoteWSHandler) NoteRePush(c *pkgapp.WebsocketClient, msg *pkgapp.WebSocketMessage) {
	...
	uid := c.User.UID
	note, err := h.App.GetNoteServiceWithVault(c.Context(), params.Vault, c.ClientType, c.ClientName, c.ClientVersion).Get(c.Context(), uid, params)
	if err != nil {
